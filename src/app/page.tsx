...
export default function Home() {
  ...
  const images = [
    ...
    { url: '/images/common5.jpeg', alt: 'Image 3', sound: '/sounds/bruh (common) (new).mp3' },
    ...
    { url: '/images/common12.jpeg', alt: 'Image 3', sound: '/sounds/bruh (common) (new).mp3' },
    ...
    { url: '/images/rare1.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare2.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare3.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare4.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare5.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare6.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare7.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare8.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare9.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare10.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare12.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare13.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare14.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    { url: '/images/rare15.jpg', alt: 'Image 2', sound: '/sounds/yippee (rare).mp3' },
    ...
    { url: '/images/legendary1.jpg', alt: 'Image 2', sound: '/sounds/ta da (legendary).mp3' },
    { url: '/images/legendary2.jpg', alt: 'Image 2', sound: '/sounds/ta da (legendary).mp3' },
